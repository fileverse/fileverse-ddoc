  ...
  (
    ...
    return (
      <div
        id="editor-canvas"
        className={cn(
          'h-[100vh] w-full overflow-y-auto',
          {
      ...
      >
        <nav
          id="Navbar"
          className={cn(
            'h-14 color-bg-default py-2 px-4 flex gap-[40px] items-center justify-between w-screen fixed left-0 top-0 border-b color-border-default z-50 transition-transform duration-300',
            {
