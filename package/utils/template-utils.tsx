...
const createTemplateButtons = (addTemplate: (template: JSONContent) => void): TemplateButtonProps => [
    {
        label: 'To-do',
        icon: 'ListChecks',
        onClick: () => {
...
const createMoreTemplates = (addTemplate: (template: JSONContent) => void): TemplateButtonProps => [
    {
        label: 'Meeting notes',
        icon: 'NotepadText',
        onClick: () => {
            ...
            content={
                <div className="flex flex-col gap-1 p-2 w-[12rem]">
                    ...
                    >
                        ...
                        <LucideIcon name='ChevronDown' size="sm" className={cn(isExpanded ? 'rotate-180' : '')} />
                    </Button>
                </div>
            }
        />
