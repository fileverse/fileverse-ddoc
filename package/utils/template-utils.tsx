...
const renderTemplateButtons = (
    ...
    <ButtonGroup className="template-buttons space-x-0 gap-2 absolute top-12 left-0 md:!left-[unset] md:!right-0 md:!top-0 z-50">
        ...
        <DynamicDropdown
            ...
            content={
                <div className="flex flex-col gap-2 p-2 w-[12rem]">
                    <div className='max-h-44 overflow-auto gap-2 flex flex-col'>
