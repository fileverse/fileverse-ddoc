...
const renderTemplateButtons = (
  ...
  zoomLevel: string,
    ...
    <ButtonGroup className={cn(
      ...
      {
        "md:translate-x-0": zoomLevel === "50%",
        "md:translate-x-[30%]": zoomLevel === "75%",
        "md:-translate-x-[60%]": zoomLevel === "100%",
        "md:-translate-x-[120%]": zoomLevel === "150%",
        "md:-translate-x-[180%]": zoomLevel === "200%",
        "md:-translate-x-[100%]": zoomLevel === "Fit",
      }
    )}>
