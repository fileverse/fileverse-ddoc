...
export const NodeSelector = ({
  ...
  return (
    <DynamicDropdown
      ...
      anchorTrigger={
        <button
          className="bg-transparent hover:!bg-[#F2F4F5] !color-text-default rounded p-2 flex items-center justify-between gap-2 w-fit max-w-36"
        >
          <span className="text-body-sm !color-text-default truncate">{activeItem.name}</span>
